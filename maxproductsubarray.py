...
def maxsubarrayproduct(arr):
    ...
    for i in range(0, n):
        ...
        if arr[i] > 0:
            ...
            flag=1
            # If this element is 0, then the maximum product cannot end here, make both max_ending_here and min_ending_here 0 Assumption: Output is
            #alway greater than or equal to 1. 
        elif arr[i] == 0:
        ...
        print(max_ending_here,min_ending_here)
